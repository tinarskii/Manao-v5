...
const P = { type: "error", data: "parser error" },
  Q =
    typeof Blob == "function" ||
    (typeof Blob < "u" &&
      Object.prototype.toString.call(Blob) === "[object BlobConstructor]"),
  j = typeof ArrayBuffer == "function",
  G = (i) =>
  ...
  V = ({ type: i, data: e }, t, s) =>
    Q && e instanceof Blob
      ? t
        ? s(e)
        : $(e, s)
      : j && (e instanceof ArrayBuffer || G(e))
        ? t
          ? s(e)
          : $(new Blob([e]), s)
        : s(y[i] + (e || "")),
...
let B;
function he(i, e) {
  if (Q && i.data instanceof Blob) return i.data.arrayBuffer().then(Y).then(e);
  if (j && (i.data instanceof ArrayBuffer || G(i.data))) return e(Y(i.data));
  V(i, !1, (t) => {
...
for (let i = 0; i < z.length; i++) E[z.charCodeAt(i)] = i;
const ue = (i) => {
    let e = i.length * 0.75,
      t = i.length,
      s,
    ...
    for (s = 0; s < t; s += 4)
      (r = E[i.charCodeAt(s)]),
        (o = E[i.charCodeAt(s + 1)]),
        (c = E[i.charCodeAt(s + 2)]),
        (h = E[i.charCodeAt(s + 3)]),
        (f[n++] = (r << 2) | (o >> 4)),
        (f[n++] = ((o & 15) << 4) | (c >> 2)),
        (f[n++] = ((c & 3) << 6) | (h & 63));
    return g;
  },
  fe = typeof ArrayBuffer == "function",
  M = (i, e) => {
    if (typeof i != "string") return { type: "message", data: Z(i, e) };
    const t = i.charAt(0);
    return t === "b"
      ? { type: "message", data: le(i.substring(1), e) }
      : T[t]
        ? i.length > 1
          ? { type: T[t], data: i.substring(1) }
          : { type: T[t] }
        : P;
  },
  le = (i, e) => {
  ...
  return new TransformStream({
    transform(i, e) {
      he(i, (t) => {
        ...
        i.data && typeof i.data != "string" && (n[0] |= 128),
          e.enqueue(n),
          e.enqueue(t);
      });
    },
    ...
    transform(o, c) {
      for (t.push(o); ; ) {
        if (s === 0) {
          ...
          if (k(t) < 2) break;
          const h = A(t, 2);
          (n = new DataView(h.buffer, h.byteOffset, h.length).getUint16(0)),
            (s = 3);
        } else if (s === 2) {
          if (k(t) < 8) break;
          const h = A(t, 8),
            g = new DataView(h.buffer, h.byteOffset, h.length),
            f = g.getUint32(0);
...
function me(i) {
  for (var e in u.prototype) i[e] = u.prototype[e];
  return i;
}
...
const be = l.setTimeout,
  we = l.clearTimeout;
function S(i, e) {
  e.useNativeTimers
    ? ((i.setTimeoutFn = be.bind(l)), (i.clearTimeoutFn = we.bind(l)))
    : ((i.setTimeoutFn = l.setTimeout.bind(l)),
      (i.clearTimeoutFn = l.clearTimeout.bind(l)));
}
const ve = 1.33;
function Ee(i) {
  return typeof i == "string"
    ? ke(i)
    : Math.ceil((i.byteLength || i.size) * ve);
}
function ke(i) {
  let e = 0,
    t = 0;
...
class Oe extends H {
  ...
  onData(e) {
    ...
    de(e, this.socket.binaryType).forEach(t),
...
class d extends u {
  ...
  _create() {
    ...
    try {
      ...
      (e = this._opts.cookieJar) === null || e === void 0 || e.addCookies(s),
    ...
    typeof document < "u" &&
      ((this._index = d.requestsCount++), (d.requests[this._index] = this));
  }
  _onError(e) {
  ...
  _cleanup(e) {
    if (!(typeof this._xhr > "u" || this._xhr === null)) {
      ...
      typeof document < "u" && delete d.requests[this._index],
        (this._xhr = null);
    }
  }
  _onLoad() {
...
class Ne extends Be {
  ...
  request(e = {}) {
    return (
      Object.assign(e, { xd: this.xd }, this.opts), new d(re, this.uri(), e)
    );
  }
}
function re(i) {
  const e = i.xdomain;
  try {
    if (typeof XMLHttpRequest < "u" && (!e || Ce)) return new XMLHttpRequest();
  } catch {}
  if (!e)
    try {
...
class Le extends H {
  ...
  uri() {
    const e = this.opts.secure ? "wss" : "ws",
      t = this.query || {};
    return (
      this.opts.timestampRequests && (t[this.opts.timestampParam] = ie()),
    ...
    this._transport.closed
      ...
      this._transport.ready.then(() => {
        this._transport.createBidirectionalStream().then((e) => {
          const t = ge(Number.MAX_SAFE_INTEGER, this.socket.binaryType),
...
const De = { websocket: Pe, webtransport: qe, polling: Ne },
  Ie =
  ...
  return (
    t != -1 &&
      ...
      (r.authority = r.authority
        ...
        .replace(/;/g, ":")),
      (r.ipv6uri = !0)),
    (r.pathNames = Fe(r, r.path)),
    (r.queryKey = Ve(r, r.query)),
    r
  );
}
function Fe(i, e) {
...
class _ extends u {
  constructor(e, t) {
    if (
      ...
      const s = q(e);
      (t.hostname = s.host),
        (t.secure = s.protocol === "https" || s.protocol === "wss"),
        (t.port = s.port),
    ...
    S(this, t),
      ...
      typeof this.opts.query == "string" &&
        (this.opts.query = Te(this.opts.query)),
      D &&
        ...
        this.hostname !== "localhost" &&
          ...
          R.push(this._offlineEventListener))),
  ...
  onOpen() {
    (this.readyState = "open"),
      (_.priorWebsocketSuccess = this.transport.name === "websocket"),
          ...
          if (!s)
            if (m.type === "pong" && m.data === "probe") {
              if (
                ...
                return;
              (_.priorWebsocketSuccess = t.name === "websocket"),
...
function Ke(i, e = "", t) {
  ...
  return (
    ...
    (s.href =
      s.protocol + "://" + r + (t && t.port === s.port ? "" : ":" + s.port)),
    s
  );
}
const We = typeof ArrayBuffer == "function",
  ...
  Ye =
    typeof Blob == "function" ||
    (typeof Blob < "u" && ae.call(Blob) === "[object BlobConstructor]"),
  ze =
    typeof File == "function" ||
    (typeof File < "u" && ae.call(File) === "[object FileConstructor]");
function K(i) {
  return (
    (We && (i instanceof ArrayBuffer || $e(i))) ||
    (Ye && i instanceof Blob) ||
    (ze && i instanceof File)
  );
}
function O(i, e) {
  if (!i || typeof i != "object") return !1;
  if (Array.isArray(i)) {
    for (let t = 0, s = i.length; t < s; t++) if (O(i[t])) return !0;
    return !1;
  }
  if (K(i)) return !0;
  if (i.toJSON && typeof i.toJSON == "function" && arguments.length === 1)
    return O(i.toJSON(), !0);
  for (const t in i)
    if (Object.prototype.hasOwnProperty.call(i, t) && O(i[t])) return !0;
  return !1;
}
function Je(i) {
  const e = [],
    ...
    s = i;
  return (
    (s.data = I(t, e)), (s.attachments = e.length), { packet: s, buffers: e }
  );
}
function I(i, e) {
  if (!i) return i;
  if (K(i)) {
    ...
    for (let s = 0; s < i.length; s++) t[s] = I(i[s], e);
    return t;
...
function U(i, e) {
  ...
  if (i && i._placeholder === !0) {
    ...
    for (let t = 0; t < i.length; t++) i[t] = U(i[t], e);
...
class je {
  ...
  encode(e) {
    return (e.type === a.EVENT || e.type === a.ACK) && O(e)
      ? this.encodeAsBinary({
...
class W extends u {
  ...
  decodeString(e) {
    ...
    if (e.charAt(++t)) {
      ...
      if (W.isPayloadValid(s.type, r)) s.data = r;
    ...
    switch (e) {
      ...
      case a.BINARY_EVENT:
        return (
          Array.isArray(t) &&
          (typeof t[0] == "number" ||
            (typeof t[0] == "string" && Qe.indexOf(t[0]) === -1))
        );
      case a.ACK:
      case a.BINARY_ACK:
...
class ce extends u {
  ...
  _addToQueue(e) {
    ...
    e.push(
      (n, ...r) => (
        this._queue[0],
        n !== null
          ? s.tryCount > this._opts.retries && (this._queue.shift(), t && t(n))
  ...
  ack(e) {
    ...
    let s = !1;
    return function (...n) {
      s || ((s = !0), t.packet({ type: a.ACK, id: e, data: n }));
    };
  }
  onack(e) {
  ...
  constructor(e, t) {
    ...
    super(),
      ...
      this.randomizationFactor(
        (s = t.randomizationFactor) !== null && s !== void 0 ? s : 0.5,
      ),
      (this.backoff = new b({
  ...
  socket(e, t) {
    ...
    return (
      s
        ...
        : ((s = new ce(this, e, t)), (this.nsps[e] = s)),
      s
    );
  }
  _destroy(e) {
...
function L(i, e) {
  ...
  const t = Ke(i, e.path || "/socket.io"),
    s = t.source,
    n = t.id,
    r = t.path,
    o = v[n] && r in v[n].nsps,
    c = e.forceNew || e["force new connection"] || e.multiplex === !1 || o;
  let h;
  return (
    c ? (h = new F(s, e)) : (v[n] || (v[n] = new F(s, e)), (h = v[n])),
    t.query && !e.query && (e.query = t.queryKey),
    h.socket(t.path, e)
  );
}
Object.assign(L, { Manager: F, Socket: ce, io: L, connect: L });
export { L as l };
